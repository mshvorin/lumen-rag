...
export default function Home() {
  ...
  const [threshold,setThreshold]=useState(.35), [answer,setAnswer]=useState<Answer|null>(null), [asking,setAsking]=useState(false);
